package com.spring.employees.utility;
...
public class JWTUtility {
    ...
    public String generateJWT(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(SecurityConstant.MFORTUNE).withAudience(SecurityConstant.MFORTUNE_ADMIN)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(SecurityConstant.MFORTUNE).build();
