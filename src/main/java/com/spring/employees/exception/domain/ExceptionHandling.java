...
public class ExceptionHandling implements ErrorController {
    ...
    private static final String INTERNAL_SERVER_ERROR_MSG = "A sudden error occurred while processing the request";
    ...
    private static final String ERROR_PROCESSING_FILE = "An error occurred during processing the file";
