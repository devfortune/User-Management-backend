...
public class EmailConstant {
    ...
    public static final String USERNAME = "meznfortune@gmail.com";
    public static final String PASSWORD = "apieceofluck9";
    public static final String FROM_EMAIL = "meznfortune@gmail.com";
